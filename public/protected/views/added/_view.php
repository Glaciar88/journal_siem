...
<div class="view">
	...
	<div class="item">
		<div class="item_info">
			<span><?php echo CHtml::encode($data->getAttributeLabel('user_id_add')); ?>: <?php echo CHtml::link(CHtml::encode($data->user->name), array('user/view', 'id'=>$data->user->id)); ?></span><span class="date_add"><?php echo Yii::app()->dateFormatter->format('d MMMM yyyy в HH:MM', $data->date_add);?></span><a href="#" class="fright"><span class="block_id"><?php echo CHtml::encode($data->block->name); ?></span></a><span class="edit"><?php echo CHtml::link(CHtml::encode($data->getAttributeLabel('Редактировать'), $data->id), array('update', 'id'=>$data->id)); ?></span>
		</div>
		<div class="_fclear">
